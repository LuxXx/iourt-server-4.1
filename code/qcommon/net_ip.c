...
qboolean Sys_IsLANAddress( netadr_t adr ) {
	...
	// The code below is totally broken.  For example, my network interface is:
	//
	// em0: flags=8843<UP,BROADCAST,RUNNING,SIMPLEX,MULTICAST> metric 0 mtu 1500
	//         options=19b<RXCSUM,TXCSUM,VLAN_MTU,VLAN_HWTAGGING,VLAN_HWCSUM,TSO4>
	//         ether 00:30:48:f8:fb:46
	//         inet 64.156.193.115 netmask 0xffffff00 broadcast 64.156.193.255
	//         media: Ethernet autoselect (1000baseT <full-duplex>)
	//         status: active
	//
	// I pass in two example IP addresses, 64.156.192.169 and 64.188.141.120.
	// Both are reported as LAN addresses by this function.  Totally wrong!
